...
int main(int argc, char **argv) {
    ...
    stoke->computeAngle(publishedName);
    goalLocation = stoke->getPosition();
    goalLocation.x = 1.5*cos(goalLocation.theta);
    goalLocation.y = 1.5*sin(goalLocation.theta);
    ...
    MobilityHelper mh(r2d2, &mNH, stoke);
